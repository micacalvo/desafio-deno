...
const DB_USERS: User[] = [];
DB_USERS.push({uuid: "1", name: 'Micaela Calvo', birthDate: new Date()});
DB_USERS.push({uuid: "2", name: 'Mauricio Calvo', birthDate: new Date()});
DB_USERS.push({uuid: "3", name: 'Ana Gonzalez', birthDate: new Date()});
DB_USERS.push({uuid: "4", name: 'Aldo Calvo', birthDate: new Date()});
